...
#define SERV_0_HEADER "MotorTester.h"
// the name of the Init function
#define SERV_0_INIT InitMotorTester
// the name of the run function
#define SERV_0_RUN RunMotorTester
...
#if NUM_DIST_LISTS > 0 
#define DIST_LIST0 PostMotorTester
#endif
#if NUM_DIST_LISTS > 1 
