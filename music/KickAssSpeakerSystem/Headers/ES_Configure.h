...
#define SERV_0_HEADER "WTV020SDService.h"
// the name of the Init function
#define SERV_0_INIT InitWTV
// the name of the run function
#define SERV_0_RUN RunWTV
...
typedef enum {  ES_NO_EVENT = 0,
                ...
                WTVResetComplete,
                WTVPlaySound,
                WTVTransferComplete} ES_EventTyp_t ;			
...
#define TIMER15_RESP_FUNC PostWTV
