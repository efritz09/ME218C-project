...
#define SERV_0_HEADER "SpectreXbee.h"
// the name of the Init function
#define SERV_0_INIT InitSpectreXbee
// the name of the run function
#define SERV_0_RUN RunSpectreXbee
...
#if NUM_SERVICES > 1
// the header file with the public function prototypes
#define SERV_1_HEADER "MotorDriver.h"
// the name of the Init function
#define SERV_1_INIT  InitMotorDriver
// the name of the run function
#define SERV_1_RUN  RunMotorDriver
// How big should this services Queue be?
...
#if NUM_SERVICES > 2
// the header file with the public function prototypes
#define SERV_2_HEADER "CommRxSM.h"
// the name of the Init function
#define SERV_2_INIT InitCommRxSM
// the name of the run function
#define SERV_2_RUN RunCommRxSM
// How big should this services Queue be?
...
#if NUM_SERVICES > 3
// the header file with the public function prototypes
#define SERV_3_HEADER "Balloon.h"
// the name of the Init function
#define SERV_3_INIT InitBalloon
// the name of the run function
#define SERV_3_RUN RunBalloon
// How big should this services Queue be?
...
#if NUM_SERVICES > 4
// the header file with the public function prototypes
#define SERV_4_HEADER "SensorComms.h"
// the name of the Init function
#define SERV_4_INIT InitSensorComms
// the name of the run function
#define SERV_4_RUN RunSensorComms
// How big should this services Queue be?
...
#if NUM_SERVICES > 5
// the header file with the public function prototypes
#define SERV_5_HEADER "WTV020SDService.h"
// the name of the Init function
#define SERV_5_INIT InitWTV
// the name of the run function
#define SERV_5_RUN RunWTV
// How big should this services Queue be?
...
#if NUM_DIST_LISTS > 0 
#define DIST_LIST0 PostCommRxSM
#endif
#if NUM_DIST_LISTS > 1 
#define DIST_LIST1 PostSpectreXbee
#endif
#if NUM_DIST_LISTS > 2 
#define DIST_LIST2 PostMotorDriver
#endif
#if NUM_DIST_LISTS > 3 
...
#define TIMER0_RESP_FUNC PostCommRxSM
#define TIMER1_RESP_FUNC PostSpectreXbee
#define TIMER2_RESP_FUNC PostSpectreXbee
#define TIMER3_RESP_FUNC PostBalloon
#define TIMER4_RESP_FUNC PostSensorComms
#define TIMER5_RESP_FUNC PostWTV
...
#define RxTimer 0
#define CommTimer 1
#define RejectTimer 2
#define PopTimer 3
#define SensorCommsTimer 4
#define WTV_TIMER 5
