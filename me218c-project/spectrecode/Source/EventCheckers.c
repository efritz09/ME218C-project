  ...
  if ( IsNewKeyReady() ) // new key waiting?
  {
    ...
    if ( ThisEvent.EventParam == 'p'){
      ES_Event NewEvent;
			...
			NewEvent.EventType = Pop; 
			PostBalloon(NewEvent);
			//PostSpectreXbee(NewEvent);
			
    }else if ( ThisEvent.EventParam == '1'){
      ES_Event NewEvent;
			NewEvent.EventType = PackageReceived;
      ...
      ES_Event NewEvent;
			NewEvent.EventType = ByteReceived;
			NewEvent.EventParam = 0x7E; // start delimeter
			//broadcasting
			PostCommRxSM(NewEvent);
		}
		else if ( ThisEvent.EventParam == '3'){
      ES_Event NewEvent;
			NewEvent.EventType = ByteReceived;
			NewEvent.EventParam = 0x00; // MSB length
			//broadcasting
			PostCommRxSM(NewEvent);
		}
		else if ( ThisEvent.EventParam == '4'){
      ES_Event NewEvent;
			NewEvent.EventType = ByteReceived; // LSB length
			NewEvent.EventParam = 0x0C;
			//broadcasting
			PostCommRxSM(NewEvent);
		}
      ...
      ES_Event NewEvent;
			NewEvent.EventType = ByteReceived; 
			NewEvent.EventParam = 0x00;// data 0
			//broadcasting
			PostCommRxSM(NewEvent);
		}
		else if ( ThisEvent.EventParam == '6'){
      ES_Event NewEvent;
			NewEvent.EventType = ByteReceived;// data 1
			NewEvent.EventParam = 0x01;
			//broadcasting
			PostCommRxSM(NewEvent);
		}
      ...
      ES_Event NewEvent;
			NewEvent.EventType = ByteReceived;
			NewEvent.EventParam = 0x02;// data 2
			//broadcasting
			PostCommRxSM(NewEvent);
		}
      ...
      ES_Event NewEvent;
			NewEvent.EventType = ByteReceived;
			NewEvent.EventParam = 0x03;// data 3
			//broadcasting
			PostCommRxSM(NewEvent);
		}
		else if ( ThisEvent.EventParam == '9'){
      ES_Event NewEvent;
			NewEvent.EventType = ByteReceived;// data 4
			NewEvent.EventParam = 0x04;
			//broadcasting
			PostCommRxSM(NewEvent);
		}
      ...
      ES_Event NewEvent;
			NewEvent.EventType = ByteReceived;
			NewEvent.EventParam = 0x05; // data 5
			//broadcasting
			PostCommRxSM(NewEvent);
		}
      ...
      ES_Event NewEvent;
			NewEvent.EventType = ByteReceived;
			NewEvent.EventParam = 0x06; // data 5
			//broadcasting
			PostCommRxSM(NewEvent);
		}
      ...
      ES_Event NewEvent;
			NewEvent.EventType = ByteReceived;
			NewEvent.EventParam = 0x07; // data 7
			//broadcasting
			PostCommRxSM(NewEvent);
		}
      ...
      ES_Event NewEvent;
			NewEvent.EventType = ByteReceived;
			NewEvent.EventParam = 0x08; // data 8
			//broadcasting
			PostCommRxSM(NewEvent);
		}
      ...
      ES_Event NewEvent;
			NewEvent.EventType = ByteReceived;
			NewEvent.EventParam = 0x09; // data 9
			//broadcasting
			PostCommRxSM(NewEvent);
		}
      ...
      ES_Event NewEvent;
			NewEvent.EventType = ByteReceived;
			NewEvent.EventParam = 0x0A; // data 10
			//broadcasting
			PostCommRxSM(NewEvent);
		}
      ...
      ES_Event NewEvent;
			NewEvent.EventType = ByteReceived;
			NewEvent.EventParam = 0x0B; // data 11
			//broadcasting
			PostCommRxSM(NewEvent);
		}
      ...
      ES_Event NewEvent;
			NewEvent.EventType = ByteReceived;
			NewEvent.EventParam = 0xBD; // Checksum
			//broadcasting
			PostCommRxSM(NewEvent);
		}
		else if ( ThisEvent.EventParam == 'i'){
      ES_Event NewEvent;
			NewEvent.EventType = BeginTransfer;
			NewEvent.EventParam = 0; // Checksum
			//broadcasting
      ...
      ES_Event NewEvent;
			...
			NewEvent.EventParam = 69; // Checksum
			//broadcasting
			PostSpectreXbee(NewEvent);
		}
      ...
      ES_Event NewEvent;
			NewEvent.EventType = ES_TIMEOUT;
			NewEvent.EventParam = 70; // Checksum
			//broadcasting
			PostSpectreXbee(NewEvent);
		}
            ...
            ES_Event NewEvent = {WTVPlaySound, 0x0000};
            printf("Play\r\n");
            PostWTV(NewEvent);
		}
