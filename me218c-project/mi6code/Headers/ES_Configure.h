...
#define SERV_0_HEADER "MI6.h"
// the name of the Init function
#define SERV_0_INIT InitMI6
// the name of the run function
#define SERV_0_RUN RunMI6
...
#if NUM_SERVICES > 1
// the header file with the public function prototypes
#define SERV_1_HEADER "CommRxSM.h"
// the name of the Init function
#define SERV_1_INIT InitCommRxSM
// the name of the run function
#define SERV_1_RUN RunCommRxSM
// How big should this services Queue be?
...
#if NUM_SERVICES > 2
// the header file with the public function prototypes
#define SERV_2_HEADER "MI6.h"
// the name of the Init function
#define SERV_2_INIT InitMI6
// the name of the run function
#define SERV_2_RUN RunMI6
// How big should this services Queue be?
...
#define TIMER1_RESP_FUNC PostMI6
#define TIMER2_RESP_FUNC PostMI6
#define TIMER3_RESP_FUNC PostMI6
#define TIMER4_RESP_FUNC PostMI6
#define TIMER5_RESP_FUNC PostMI6
#define TIMER6_RESP_FUNC PostMI6
...
#define PulseTimer 2
#define PopTimer 3
#define WatchInitTimer 4
#define SobrietyTimer 5
#define debounceTimer 6
#endif /* CONFIGURE_H */
